...
export default function WriteBlog({setUpdate}) {
  ...
  return (
     ...
     <div className='mt-8 flex flex-col items-center'>
      ...
      <div>
        ...
        <input className='mt-4 p-2 w-full border rounded-lg border-slate-900' type="text" onChange={
          (e)=>{
      ...
      <div className='mt-6 flex flex-col'>
        ...
        <textarea className='p-2 mt-4 border round border-slate-900' name="textarea" rows= '11' cols='90' onChange={
          (e)=>{
